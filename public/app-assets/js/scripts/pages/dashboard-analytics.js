...
var pendingOrdersChartOrder = {
  ...
  var pendingOrders = new ApexCharts(
    document.querySelector("#pending-orders"),
    pendingOrdersChartOrder
  );

  pendingOrders.render();

  var todayTotalChartOrder = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  var todayTotalOrder = new ApexCharts(
    document.querySelector("#today-total-order"),
    todayTotalChartOrder
  );

  todayTotalOrder.render();

  var deliveryChartOrder = {
    chart: {
      height: 100,
      type: 'area',
      toolbar: {
  ...
  var deliverylOrder = new ApexCharts(
    document.querySelector("#delivery-orders"),
    deliveryChartOrder
  );

  deliverylOrder.render();
